...
setTimeout(() => {
    addStar(window.innerWidth * 0.3, window.innerHeight * 0.3);
    addStar(window.innerWidth * 0.4, window.innerHeight * 0.4);
    addStar(window.innerWidth * 0.5, window.innerHeight * 0.35);
    addStar(window.innerWidth * 0.45, window.innerHeight * 0.55);
    addStar(window.innerWidth * 0.35, window.innerHeight * 0.5);
}, 500);
